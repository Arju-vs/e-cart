      ...
      <div className="grid grid-cols-3 gap-4 mt-5">
        <div className="col-span-2 border rounded p-5 shadow">
          <table className="table-auto w-full">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>Product Name</td>
                <td><img width={'70px'} height={'70px'} src="https://specials-images.forbesimg.com/imageserve/65df2e0562b5d061b718a4af/960x0.jpg" alt="" /></td>
                <td>
                  <div className="flex">
          ...
          <div className="float-right mt-5">
            ...
            <button className="bg-blue-600 ms-2 rounded p-2 text-white">SHOP MORE</button>
          </div>
        </div>
